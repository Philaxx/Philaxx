...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC") or "https://telegra.ph/file/3e63de838f3094a6fc8e4.jpg"
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/Philaxx/Philaxx-Ubot")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "Philaxx-Ubot")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Philaxx-Ubot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/3e63de838f3094a6fc8e4.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/3e63de838f3094a6fc8e4.jpg"
...
async def check_alive():
    await bot.send_file(BOTLOG_CHATID, ALIVE_LOGO, caption=f"**𝕻𝖍𝖎𝖑𝖆𝖝𝖝-𝖀𝖇𝖔𝖙 Berhasil Diaktifkan✨**\n━━━━━━━━━━━━━━━━━━━\n❃ **ʙᴏᴛ ᴏꜰ :** {ALIVE_NAME}\n❃ **ʙᴏᴛ ᴠᴇʀ :** 7.0\n━━━━━━━━━━━━━━━━━━━\n❃ **sᴜᴘᴘᴏʀᴛ​ :** @Lodmlbb\n❃ **ᴄʜᴀɴɴᴇʟ​ :** @gbwrml \n━━━━━━━━━━━━━━━━━━━")
    return
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× **Pembaruan Data Untuk 𝕻𝖍𝖎𝖑𝖆𝖝𝖝-𝖀𝖇𝖔𝖙, Command Untuk Pembaruan**.\n"
                    f"⚒Pembaruan Data :\n"
                    f"`.update deploy`\n"
                    f"`update`\n\n"
                    f"© @IDnyaPhilax")
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    ...
                    buttons=[
                        ...
                        [custom.Button.url(
                            "License",
                            "https://github.com/Philaxx/Philaxx-Ubot/LICENSE")],
                    ],
                    link_preview=False,
                )
