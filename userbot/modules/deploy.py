...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "Heroku Connecting To Latest Github Build (Philaxx/Philaxx-Ubot)",
        ...
        "INFO - Philaxx-Ubot: Logged in as 557667062",
        "INFO - Philaxx-Ubot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Philaxx-Ubot -",
        "INFO -  ☠𝕻𝖍𝖎𝖑𝖆𝖝𝖝-𝖀𝖇𝖔𝖙☠  ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
